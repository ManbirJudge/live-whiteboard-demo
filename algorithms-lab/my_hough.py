...
from Utils import Stroke, linspace, PYPLOT_CMAPS, rand_color, rand_color_hex


# functions
def hough_py(img: List[List[int]], thetas: List[int] = None) -> (List[int], List[int], List[List[int]]):
